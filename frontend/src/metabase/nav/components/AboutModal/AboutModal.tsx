...
export const AboutModal = ({
  ...
  const { tag, date, hash: _hash, ...versionExtra } = version;
          ...
          {showTrademark && (
            <>
              ...
              <Stack align="center" gap={0}>
                ...
                {/* eslint-disable-next-line i18next/no-literal-string -- URL, not a translatable string */}
                <Text fz="sm" c="text-secondary" style={{ userSelect: "text" }}>
                  https://github.com/realpoweriot/dataveritas
                </Text>
              </Stack>
            </>
          )}
