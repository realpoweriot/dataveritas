...
(defn- build-frontend! [edition]
  ...
  (let [mb-edition (case edition
    ...
    (u/step (format "Build frontend with MB_EDITION=%s" mb-edition)
      ...
      (let [static-viz-bundle (str u/project-root-directory "/resources/frontend_client/app/dist/lib-static-viz.bundle.js")]
        (if (.exists (java.io.File. static-viz-bundle))
          (u/announce "Skipping static viz build — pre-built artifact found at %s" static-viz-bundle)
